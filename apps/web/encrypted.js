...
(function (global) {
  ...
  class EncryptedClient {
    ...
    async catchUp(task, context) {
      ...
      // Keep delivery status for failed replay guidance. Previously imported history
      // may still verify while new delivery is waiting on membership.
      let delivery = null;
      ...
      try {
        ...
        // Report the actionable enrollment prerequisite without claiming the log
        // verified. A new handoff would wait in the same mailbox. Replay errors such
        // as rollback remain distinct, and successful restored history is retained.
